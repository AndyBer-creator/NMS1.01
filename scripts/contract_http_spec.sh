...
assert_regex "$openapi_body" '/incidents/\{incidentID\}/assignee:' "contract: /api/openapi.yaml is missing /incidents/{incidentID}/assignee path"
assert_regex "$openapi_body" '/itsm/inbound:' "contract: /api/openapi.yaml is missing /itsm/inbound path"
assert_regex "$openapi_body" '/itsm/inbound/dry-run:' "contract: /api/openapi.yaml is missing /itsm/inbound/dry-run path"
assert_regex "$openapi_body" '/itsm-inbound-mappings:' "contract: /api/openapi.yaml is missing /itsm-inbound-mappings path"
assert_regex "$openapi_body" '/settings/incident-automation-snapshot:' "contract: /api/openapi.yaml is missing /settings/incident-automation-snapshot path"
...
assert_regex "$openapi_body" 'IncidentAssignRequest' "contract: openapi is missing IncidentAssignRequest schema"
assert_regex "$openapi_body" 'ITSMInboundIncidentUpdateRequest' "contract: openapi is missing ITSMInboundIncidentUpdateRequest schema"
assert_regex "$openapi_body" 'ITSMInboundDryRunResponse' "contract: openapi is missing ITSMInboundDryRunResponse schema"
assert_regex "$openapi_body" 'ITSMInboundMapping' "contract: openapi is missing ITSMInboundMapping schema"
assert_regex "$openapi_body" 'IncidentAutomationSnapshotResponse' "contract: openapi is missing IncidentAutomationSnapshotResponse schema"
